...
bool c_config::save_config(std::string file_name) {
	std::string file_path = "C:\\spuriii\\" + file_name + ".cfg";
...
bool c_config::load_config(std::string file_name) {
	CreateDirectory("C:\\spuriii", NULL);
...
void c_config::create_config(std::string name) {
	CreateDirectory("C:\\spuriii\\", NULL); CreateDirectory("C:\\spuriii\\", NULL);
	std::ofstream ofs("C:\\spuriii\\" + name + ".cfg");
}
