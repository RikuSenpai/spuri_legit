...
public:
	...
	bool key_strokes = false;
	bool draw_velocity = false;
	int auto_strafers = 0;
	bool hand_chams = false;
	float clr_hand_chams[4] = { 1.0f,1.0f,1.0f,1.0f };
	bool sleeve_chams = false;
	float clr_sleeve_chams[4] = { 1.0f,1.0f,1.0f,1.0f };
	bool weapon_chams = false;
	float clr_weapon_chams[4] = { 1.0f,1.0f,1.0f,1.0f };
	bool remove_weapon = false;
	int vis_chams_misc_type = 0;
	int aimbot_mode = 0;
	bool no_recoil = false;
	bool third_person = false;
	bool vis_chams_misc_wireframe = false;
	int third_person_distance = 0;
	int third_person_key;
	bool chams_epilepsy = false;
	bool chams_shiny = false;
	float clr_chams_shiny[4] = { 1.0f,1.0f,1.0f,1.0f };
	int free_cam_key;
	...
	int name_spam = 0;
	bool auto_strafers_silent = false;
	bool nade_pred = false;
	bool fake_lag_enable = false;
	int fake_lag_type = 2;
	int fake_lag_amount = 0;
