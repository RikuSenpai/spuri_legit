...
public:
	...
	vec3_t direction()
	{
		return vec3_t(cos(y * M_PI / 180.0f) * cos(x * M_PI / 180.0f), sin(y * M_PI / 180.0f) * cos(x * M_PI / 180.0f), sin(-x * M_PI / 180.0f)).normalized();
	}
	...
	vec3_t up()
	{
		return vec3_t(cos(y * M_PI / 180.0f) * cos(x * M_PI / 180.0f), sin(y * M_PI / 180.0f) * cos(x * M_PI / 180.0f), sin(-(x - 90.0f) * M_PI / 180.0f)).normalized();
	}

	vec3_t right()
	{
		return vec3_t(cos((y + 90.f) * M_PI / 180.0f) * cos(x * M_PI / 180.0f), sin((y + 90.f) * M_PI / 180.0f) * cos(x * M_PI / 180.0f), sin(-x * M_PI / 180.0f)).normalized();
	}
